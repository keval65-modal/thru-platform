-- =========================================
-- Migration: Add bank_details column to vendors table
-- =========================================
-- Run this in Supabase SQL Editor to fix the registration error
-- Dashboard > SQL Editor > New Query > Paste and Run
--
-- Error being fixed:
-- "Could not find the 'bank_details' column of 'vendors' in the schema cache"
...
DO $$
BEGIN
  RAISE NOTICE '✅ Migration complete: bank_details column added to vendors table';
END $$;

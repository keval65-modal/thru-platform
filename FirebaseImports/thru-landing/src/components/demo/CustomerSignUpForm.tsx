...
export function CustomerSignUpForm() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Listen for errors from the autocomplete
      window.google?.maps?.event?.addListener(autocompleteRef.current, 'error', (error: any) => {
        console.error('Autocomplete error:', error);
        if (error?.message?.includes('ApiTargetBlockedMapError')) {
          toast({
            title: "Location autocomplete unavailable",
            description: "Please enter your full address manually. The location will be geocoded on submit.",
            variant: "destructive",
          });
        }
      });
      ...
      toast({
        ...
        description: "Please enter your location manually. It will be geocoded on submit.",
        variant: "destructive",
      });
    }
